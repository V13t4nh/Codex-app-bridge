...
import { buildTelegramCommands, discoverTelegramSkillCommands } from '../adapters/telegram.js';
...
async function main(): Promise<void> {
  ...
  const skillCommands = discoverTelegramSkillCommands(logger);
  const commands = buildTelegramCommands(skillCommands);
  ...
  process.stdout.write(JSON.stringify({
    ...
    skillCommandsCount: skillCommands.length,
    totalCommandsCount: commands.length,
